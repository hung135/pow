...
server_settings = {
    ...
    "cookie_secret"     :   "e0b654be-d2d2-499f-96cb-03e4dfc7cccf"
}
...
myapp = {
    ...
    "default_format"    :   "json",
    "encoder"           :   {
           "json"   :   scrat.lib.encoders.json_to_json(),
            "csv"   :   scrat.lib.encoders.json_to_csv(),
            "xml"   :   scrat.lib.encoders.json_to_xml()
    },
    "byte_decoding"     :   "utf-8",
