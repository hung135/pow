...
from scrat.database.sqldblib import Base, Session, engine
from scrat.conf.config import myapp
from scrat.conf.config import routes
...
class Application(tornado.web.Application):
    ...
    def import_all_handlers(self):
        ...
        import importlib
        for m in mods:
            #print("importing: " + 'scrat.handlers.' + m)    
            try:
                mod = importlib.import_module('scrat.handlers.' + m)
            except:
                pass
            #print(dir(mod))
