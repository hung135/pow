...
from scrat.lib.powlib import get_class_name
from scrat.conf.config import myapp
from scrat.lib.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('scrat.models.sql.' + m)
